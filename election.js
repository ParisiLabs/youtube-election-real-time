...
queue()
  ...
  .defer(d3.csv, "video_rank_8.csv") //42KB - unique video ranking info
  ...
  .defer(d3.csv, "first_load_recent.csv") //29KB total views for entire date range by candidate
...
function ready(error,
  ...
  function secondLoadClean(){
    ...
    // d3.csv("views_county_5.csv", function(countyViews) {
      d3.csv("views_county_7.csv", function(countyViewsTwo) {
